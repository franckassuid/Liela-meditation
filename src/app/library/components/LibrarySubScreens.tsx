...
interface FavoritesListProps {
  ...
  handleToggleFavorite: (session: CatalogSession, isFav: boolean) => void;
...
export function FavoritesList({
  ...
  if (currentSituation || activeSegment !== "favoris") return null;
  return (
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center py-12 px-2">
          <span className="inline-flex w-[58px] h-[58px] rounded-full bg-coquille items-center justify-center mb-[14px]">
            <svg
              ...
              fill="none" stroke="#D8CAB4" strokeWidth="1.6"
...
export function HistoryList({
  ...
  if (currentSituation || activeSegment !== "historique") return null;
  return (
    <div className="flex flex-col flex-1">
      {history.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center text-center py-12 px-2">
